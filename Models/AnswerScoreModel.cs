...
namespace IISprojekt3.Models
{
  public class AnswerScoreModel
  {
    ...
    public string QuistionImage { get; set; }

    public AnswerScoreModel(Answer answer, float maxScore)
    {
      Id = answer.Id;
      ...
      QuistionImage = answer.IdQuestionNavigation.Image;
      if (Score != null || EvaluationText != null)
        SetIsSaved(true);
      else
        SetIsSaved(false);
    }
